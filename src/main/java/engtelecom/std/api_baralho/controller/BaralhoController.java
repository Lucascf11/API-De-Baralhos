...
public class BaralhoController {
    ...
    public void deletarBaralho(@PathVariable String id){
        this.baralhoService.excluirBaralho(id);
    }
    ...
    public StringBuilder retornarTodasAsCartasDeBaralho (@PathVariable String id){
        return this.formatarJsonCartas(this.baralhoService.retornarTodasAsCartasDeBaralho(id));
    }
